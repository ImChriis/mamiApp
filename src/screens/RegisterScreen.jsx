  ...
  const handleSubmit = async () => {
    try {
      ...
      const registro = {
        ...
        brazo_izquierdo_pulso: formData.brazo_izquierdo_pulso ? parseInt(formData.brazo_izquierdo_pulso, 10) : null,
        brazo_derecho_tension: formData.brazo_derecho_tension.trim() || null,
        brazo_derecho_pulso: formData.brazo_derecho_pulso ? parseInt(formData.brazo_derecho_pulso, 10) : null,
        glicemia: formData.glicemia ? parseFloat(formData.glicemia.replace(',', '.')) : null,
        peso: formData.peso ? parseFloat(formData.peso.replace(',', '.')) : null,
        oximetro_oxigeno: formData.oximetro_oxigeno ? parseInt(formData.oximetro_oxigeno, 10) : null,
        oximetro_pulso: formData.oximetro_pulso ? parseInt(formData.oximetro_pulso, 10) : null,
        edema: formData.edema,
      };

      await medicionesService.crearMedicion(registro);

      Alert.alert('Éxito', `Medición del turno ${formData.horario} guardada correctamente`);
              ...
              <View style={styles.row}>
                <View style={styles.flex1}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(val) => handleChange('brazo_izquierdo_tension', val)}
                  />
                </View>
                <View style={styles.flex1}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(val) => handleChange('brazo_izquierdo_pulso', val)}
                  />
                </View>
              </View>
              ...
              <View style={styles.row}>
                <View style={styles.flex1}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(val) => handleChange('brazo_derecho_tension', val)}
                  />
                </View>
                <View style={styles.flex1}>
                  <Text style={styles.label}>Pulso (BPM)</Text>
                  <TextInput
                    ...
                    onChangeText={(val) => handleChange('brazo_derecho_pulso', val)}
                  />
                </View>
              </View>
              ...
              <View style={styles.row}>
                <View style={styles.flex1}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(val) => handleChange('oximetro_oxigeno', val)}
                  />
                </View>
                <View style={styles.flex1}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(val) => handleChange('oximetro_pulso', val)}
                  />
                </View>
              </View>
              ...
              <View style={styles.enumRow}>
                {['No', 'Poco', 'Si'].map((option) => {
                  ...
                  return (
                    <TouchableOpacity
                      key={option}
                      style={[styles.enumButton, selected && styles.enumButtonActive]}
                      onPress={() => handleChange('edema', option)}
                    >
                      <Text style={[styles.enumText, selected && styles.enumTextActive]}>
                        {option}
                      </Text>
                    </TouchableOpacity>
                  );
